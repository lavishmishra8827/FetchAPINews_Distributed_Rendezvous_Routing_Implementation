...
def make_connection():
        ...
        mycursor=db.cursor()
        return mycursor,db
def insertintodatabase(databasename,topic,row_to_insert):
        ...
        try:
            ...
            query="Insert Into "+databasename+"."+topic
            #+" ("
            '''
            ...
            query+=");"
            print(query)
            #mycursor.execute("Insert into "+databasename+"."+topic+" values ('"+self.__id__+"','"+self.__name__+"');")
...
response=requests.get("https://newsapi.org/v2/everything?q=apple&sortBy=popularity&apiKey=7a11f7c147d64d7ba4da33b553c06ca0")
topic="Apple"
topic_url_dict[topic]=response
#newsData=response.json()
#print(newsData)
#for key in newsData.keys():
    #print(key)
databasename="testdatabase"
#topic="TECHNEWS"

for topic,newsData in topic_url_dict.items():
    ...
    for article in articles:
        ...
        print(insertintodatabase(databasename,topic,row_dict))
